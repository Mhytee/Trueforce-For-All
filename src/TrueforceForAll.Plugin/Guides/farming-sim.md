...
Your steering force does not depend on it. The plugin replaces the game's centering spring with a force of its own either way{{guide: ([what that is](guide:telemetry-ffb))|panel:}}, and the mod is the layer underneath.
