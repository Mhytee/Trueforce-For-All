...
Your steering force does not depend on it. The plugin replaces the game's centering spring with a force of its own either way{{guide: ([what that is](guide:telemetry-ffb))|panel:}}. Stationary friction on the FFB tab keeps the parked wheel firm and eases off as you drive.
...
**Remove** takes it back out, and uninstalling the plugin from Windows removes it too.
