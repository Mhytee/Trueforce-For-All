...
The plugin starts on **Lightsync only** in iRacing, which leaves the sim completely alone. On a wheel whose lights can take a pattern, it also sets that pattern to match the car you are in. For the rest, four steps, once:
