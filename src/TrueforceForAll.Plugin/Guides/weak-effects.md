...
All of the intensity is set in the plugin instead, and it can be bound to any control so you never open the panel for it: see [what you can bind](guide:bindings).
