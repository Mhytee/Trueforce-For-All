...
The Color Trim section has **Show yellow** and **Show white** buttons that light all ten LEDs in the two colors that give a tint away soonest. Judge it on the rim rather than on screen, and move a few percent at a time.
