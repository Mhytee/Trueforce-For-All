...
# Why lights and force share a channel
...
- **[Force handover](force-handover.md)**, where the sim hands its force to the plugin instead of the wheel. iRacing, RaceRoom, and Assetto Corsa through the CSP Bridge.
