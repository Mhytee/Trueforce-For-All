...
Pointed straight at the plugin, the telemetry carries finer road texture, the airborne feel, and enough for [Telemetry Based FFB](telemetry-ffb.md) to run. Through SimHub the plugin still works, with less to build from.
...
4. Set **DATA OUT IP PORT** to match the **Port** box in the plugin's UDP telemetry settings, on the Settings tab. It is `5300` unless you changed it.
