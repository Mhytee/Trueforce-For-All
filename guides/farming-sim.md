...
Your steering force does not depend on it. The plugin replaces the game's centering spring with a force of its own either way ([what that is](telemetry-ffb.md)). Stationary friction on the force feedback tab keeps the parked wheel firm and eases off as you drive.
